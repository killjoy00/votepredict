...
test('Revisor status parser reads linked current versions and preserves canonical source year', () => {
  const html = `<html><body><h1>HF 4252</h1><p>Current bill text: <a href="/versions/latest/">4th Engrossment</a></p><h2>Description</h2><p>Omnibus Higher Education policy bill</p></body></html>`;
