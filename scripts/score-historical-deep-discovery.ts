...
import { scoreHistoricalDeepDiscoveryCandidates } from '../src/evaluation/historical-deep-outcome-scorer.js';

const candidatePath = process.argv[2];
const outcomePath = process.argv[3];
const outputPath = resolve(process.argv[4] ?? 'artifacts/historical-deep-discovery-score.json');
...
const result = scoreHistoricalDeepDiscoveryCandidates(candidates, outcomes);
