...
The evidence policy honors `metadata.mechanicallyActionable === false`, keeping context in the evaluation artifact without allowing context-only evidence to change a member probability.
