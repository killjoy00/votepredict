...
1. **Lifecycle prospective validation.** Full-universe lifecycle phases P2-P7 are complete and frozen under #310. The P8 prospective plan and exact 2027 model package are also frozen before any 2027-28 data existed (model-content SHA-256 `abcf583153939d46aa021dccf2afe61d698ad4538a981059cdee265c03166a65`). P7 `substantive_vehicle_passage_v1` adds 651 direct-vehicle positives to the 654 strict bill-number passages (1,305 total), with frozen label SHA-256 `5b18378725c736dd4eceb37992fd4295cbd779e24e3cdd92123f28192ab75eec`. The unchanged accepted v4 ranking signal transfers to the secondary target (ROC-AUC 0.78341) but is materially under-calibrated because it was trained for the narrower strict target. No recalibration or serving change is authorized. P8 clean 2027-28 prospective validation is the remaining lifecycle phase.
